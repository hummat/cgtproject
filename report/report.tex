...
\begin{figure}[ht]
 \begin{center}
  ...
  \caption{A small load balancing network \citep{garant2015accelerating}}
...
\subsection{Random Graph, Supervisory Topology, Task Allocation}
...
\subsection{Worker Q-Learning with Softmax and Experience Integration}
...
\subsection{Context Feature Construction}
